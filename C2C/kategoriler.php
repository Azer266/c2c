                        ...
                        <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                            <div class="product-list-view">
                                ...
                                if (isset($_GET['kategori_id'])) {
                                    ...
                                    $urunsor=$db->prepare("SELECT urun.*,kullanici.*,kategori.* FROM urun INNER JOIN kategori ON urun.kategori_id=kategori.kategori_id INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id WHERE urun_durum=:durum and kategori.kategori_id=:kategori_id order by urun_zaman DESC limit $limit,$sayfada");
                                    ...
                                    <div class="item-content">
                                        <div class="item-info">
                                            ...
                                            <div class="item-sale-info">
                                                ...
                                                <div class="sale-qty">Sales ( 0 )</div>
                                            </div>
                                        </div>
                            ...
                            <?php
                                ...
                                <?php
                                    ...
                                    <li><a style="background-color: #C84C3C; color: white;" href="kategoriler-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                                    ...
                                    <li>
                                      ...
                                      <a href="kategoriler-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a>
