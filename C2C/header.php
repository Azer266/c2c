                    ...
                    <div class="row">                         
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            <ul class="profile-notification">                                            
                                ...
                                <li>
                                    <div class="notify-message">
                                        <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i><span>
                                            <?php
                                            $mesajsay=$db->prepare("SELECT COUNT(mesaj_okunma) as say FROM mesaj where mesaj_okunma=:mesaj_okunma and kullanici_gel=:kullanici_gel");
                                        ...
                                        <ul>
                                            <?php 
                                            $mesajsor=$db->prepare("SELECT mesaj.*, kullanici.* FROM mesaj INNER JOIN kullanici ON mesaj.kullanici_gon=kullanici.kullanici_id where mesaj.kullanici_gel=:id and mesaj_okunma=:mesaj_okunma order by mesaj_zaman DESC limit 5");
                                            ...
                                            if ($mesajsor->rowCount()==0) {?>
                                                <li>
                                                    <div class="notify-message-info">
                                                        <div class="notify-message-subject">Mesajiniz Yok</div>
                                                    </div>
                                                </li>
                                            <?php }
                                            ...
                                            <?php $zaman1=explode(" ",$mesajcek['mesaj_zaman']) ?>
                                            <li>
                                                <div class="notify-message-img">
                                                    <img class="img-responsive" src="<?php echo $mesajcek['kullanici_magazafoto'] ?>" alt="<?php echo $mesajcek['kullanici_ad'] ." ". $mesajcek['kullanici_soyad'] ?>">
                                                </div>
                                                <div class="notify-message-info">
                                                    <div class="notify-message-sender"><?php echo $mesajcek['kullanici_ad'] ." ". $mesajcek['kullanici_soyad'] ?></div>
                                                    <a style="background-color: transparent; display: table-header-group;" href="mesaj-detay.php?mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>&kullanici_gon=<?php echo $kullanici_gon ?>"><div class="notify-message-subject">Mesaji Oku</div></a>
                                                    <div class="notify-message-date"><?php echo $zaman1[0] ?></div>
                                                </div>
                                    ...
                                    <div class="user-account-info">
                                        <div class="user-account-info-controler">
                                            <div class="user-account-img">
                                                <img style="border-radius: 50px" width="48" class="img-responsive" src="<?php echo $kullanicicek['kullanici_magazafoto'] ?>" alt="Profil Resmi">
                                            </div>
                                ...
                                <li><a class="apply-now-btn" href="logout.php" id="logout-button">Cikis</a></li>
                                <?php } else {?>

                                <li><a class="apply-now-btn hidden-on-mobile" href="login.php">Uye Girisi</a></li>
                                <li><a class="apply-now-btn-color hidden-on-mobile" href="register.php">Kayit Ol</a></li>
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                <ul>
                                    ...
                                    <li><a href="register">Uye Kayit</a></li>
                                    <li><a href="kategoriler">Kategoriler</a></li>
