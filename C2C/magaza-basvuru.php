        ...
        <div class="row settings-wrapper">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"> 
                        ...
                        <div class="settings-details tab-content">
                            <div class="tab-pane fade active in" id="Personal">
                                ...
                                <div class="personal-info inner-page-padding"> 
                                    <p>Basvuru isleminizi tamamlamak icin tum bilgilerinizi eksiksiz ve dogru giriniz. Eksik yada hatali bilgi oldugunda basvurunuz iptal edilecektir.</p>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Kullanici Ad</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sozlesme</label>
                                        <div class="checkbox col-sm-9">
                                            <label class="col-sm-9 control-label">
                                            <input required="" id="first-name" name="kullanici_onay" value="<?php echo $kullanicicek['kullanici_adres'] ?>" type="checkbox">Kullanim sartlarini kabul ediyorum.</label>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div align="right" class="col-sm-12">
                                            <button class="update-btn" name="musterimagazabasvuru" id="login-update">Basvuruyu Tamamla</button>
                                        </div>
                                    </div> 
                                    <p>Basvurular 24 saat icerisinde incelenir ve sonuclandirilir</p>                                       
                                </div> 
                            </div>                                       
                        </div> 
                ...
                elseif ($kullanicicek['kullanici_magaza']==1) {?>
                    <div class="alert alert-success">
                    <strong>Basvurunuz onay asamasinda</strong>
                    </div>
                <?php } 
                elseif ($kullanicicek['kullanici_magaza']==2) {?>
                    <div class="alert alert-success">
                    <strong>Basvurunuz onaylandi</strong>
                    <p>Magaza yonetim menusunden magazanizi yonete bilirsiniz</p>
                    </div>
                <?php } ?> 
            </div>  
        </div>  
