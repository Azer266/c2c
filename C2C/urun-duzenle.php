                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <img width="256" src="<?php echo $uruncek['urunfoto_resimyol'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required="" id="first-name" name="urun_ad" value="<?php echo $uruncek['urun_ad'] ?>" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" style="height: auto;" rows="5" id="comment" name="urun_detay"  required=""><?php echo $uruncek['urun_detay'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required="" id="first-name" name="urun_fiyat" value="<?php echo $uruncek['urun_fiyat'] ?>" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div align="right" class="col-sm-12">
                                        <button class="update-btn" name="magazaurunduzenle" id="login-update">Duzenle</button>
                                    </div>
                                </div>                                        
                            </div> 
                        </div>                                       
