                        ...
                        <table id="cart" class="table table-hover table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    <td data-th="Product">
                                        <div class="row">
                                            <div class="col-sm-2 hidden-xs"><img src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="<?php echo $uruncek['urun_ad'] ?>" class="img-responsive"/></div>
                                            <div class="col-sm-10">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <td><button onclick="geridon()" class="btn btn-warning"><i class="fa fa-angle-left"></i> Alisverise Devam Et</button> </td>
                                    ...
                                    <form action="nedmin/netting/kullanici" method="POST">
                                        ...
                                        <td><button type="submit" name="sipariskaydet" class="btn btn-success btn-block">Siparis Ver<i class="fa fa-angle-right"></i></button></td>
                                    </form>
                                </tr>
                            </tfoot>
                        </table>
