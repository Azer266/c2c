                        ...
                        <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                            <div class="product-list-view">
                                ...
                                if (isset($_POST['searchsayfa'])) {
                                    ...
                                    $urunsor=$db->prepare("SELECT urun.*,kullanici.*,kategori.* FROM urun INNER JOIN kategori ON urun.kategori_id=kategori.kategori_id INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id WHERE urun_durum=:durum and urun.urun_ad LIKE '%$searchkeyword%' order by urun_zaman DESC limit $limit,$sayfada");
